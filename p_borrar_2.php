...
<header>
    ...
    <main class="main-add-1">
        ...
        <fieldset>
            ...
            <form name="datos"  action="c_borrar_2.php" enctype="multipart/form-data" method="POST">
                ...
                <?php
                    ...
                    $query = "delete from presupuesto where id_presupuesto='$id_presupuesto'";
                    ...
                    if (mysqli_query($conexion, $query)) {
                        ...
                        <span> Se han borrado el presupuesto con número de $id_presupuesto de la base de datos.</span></div>";
                    } else {
                        
                        echo "<div class='add-1'><span >Error al borrar el presupuesto". $id_presupuesto." de la base de datos.</span></div>";
                    }
