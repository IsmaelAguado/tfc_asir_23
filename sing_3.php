...
<header>
    ...
    $codi_activacion = trim(strip_tags($_REQUEST["codi_activacion"]));
    ...
    $query = "select * from cliente where codi_activacion ='$codi_activacion'";
    ...
    if ($nfilas == 0) {
        echo "<div> El Código introducido es incorrecto.</div>";
    } else {

        if ($codi_activacion != 0){

        

        /* query */

        $query_2 = "update cliente set activado_mail='1',codi_activacion='' where codi_activacion='$codi_activacion'";
        ...
        if (mysqli_query($conexion, $query_2)) {
            ...
            <fieldset>    
                <legend>Cuenta Activada</legend>

                <div><span class='add'>La cuenta ha sido activada.</span></div>                  
            ...
            <fieldset>    
                <legend>Cuenta NO Activada</legend>

                <div><span class='add'>La cuenta no ha sido activida.</span></div>                 
        ...
        echo "   <main class='main-add'>
            <video class='vid_2' src='./video/rio.mp4' autoplay='true' muted='true' loop='true'>
            </video>
    
            
            <fieldset>    
                <legend>Error de servidor</legend>

                <div><span class='add'>Error</span></div>                 
