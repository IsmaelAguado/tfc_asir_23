...
<header>
    ...
    <main class="main-add-1">
        ...
        <fieldset>
            ...
            $query = "insert into presupuesto (provincia,localidad,calle,numero,piso,puerta,c_postal,merchandising,diseno,impresion,medida,gramaje,acabado,troquel,cantidad,fecha,precio,imagen,tipo_entrega,aceptado) values ('$provincia','$localidad','$calle','$numero','$piso','$puerta','$cp','$mercha','$diseno','$impresion','$medida','$gramo','$acabado','$troquel','$cantidad','$date','$pvp','$nombreFichero','$entrega','$aceptado');";
            ...
            if (mysqli_query($conexion, $query)) {
                echo "<span class='add'>Presupuesto añadido</span> ";
            } else {
                echo "<span class='add'>Error, no se añade presupuesto a la base de datos</span>";
            }
