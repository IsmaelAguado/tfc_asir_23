...
<header>
    ...
    <main class="main-add-1">
        ...
        <fieldset>
            ...
            <legend>Area <?php echo "$_SESSION[nombre]" ?> / Borrar Datos Cliente</legend>
                    ...
                    if (mysqli_query($conexion, $query)) {
                        ...
                        <span> Se han borrado el cliente con número de Id Usuario $id_usuario de la base de datos.</span></div>";
                    } else {
                        
                        echo "<div class='add-1'><span >Error al borrar el cliente de la base de datos.</span></div>";
                    }
