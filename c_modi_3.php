...
$query = "update cliente set nombre='$nombre',apellido_1='$apellido_1', apellido_2='$apellido_2',telefono='$telefono',mail='$mail', clave='$clave_encriptada', tipo_usuario='$tipo' where id_usuario='$id_usuario'";

/* Ejecutamos la query y control de error */

if (mysqli_query($conexion, $query)) {
    echo "<br><br><br>";
    echo "<span class='add-2'> Actualizado Cliente " . $nombre . "</span>";
    
} else {
    echo "<br><br><br>";
    echo "<div><span class='add-2'>Error, revise los datos</span></div>";
}
