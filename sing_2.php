...
<header>
    ...
    $query = "select * from cliente where mail='$email'";
    ...
    if ($nfilas != 0) {
        echo "
            ...
            <fieldset>    
                ...
                <div><span class='add'>El mail introducido ya existe.</span></div>                  
    ...
    elseif ($email == ''){
        ...
        <fieldset>    
            ...
            <div><span class='add'>El mail introducido esta vacio.</span></div>                  
        ...
        $query_2 = "insert into cliente (nombre,apellido_1,apellido_2,telefono,mail,clave,tipo_usuario,codi_activacion,activado_mail) values ('$nombre','$apellido_1','$apellido_2','$telf','$email','$clave_encriptada','$tipo','$codi_activacion',0)";

        /* Ejecutamos la query y control de error */

        if (mysqli_query($conexion, $query_2)) {

            enviar_mail($email,$nombre,$codi_activacion);
            ...
            <fieldset>    
                ...
                <tr>
                    <td><span class='add'>Código Activación:</span></td>
