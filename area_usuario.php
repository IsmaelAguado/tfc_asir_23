...
<header>
    ...
    <main class="main-add">
        ...
        <fieldset>
            ...
            <legend>Area <?php echo "$_SESSION[nombre]" ?></legend>
            <p class="ini">Hazte la vida más facil con ayuda de nuestros productos</p> 
            <br><br><br><br><br><br><br><br><br><br><br><br><br><br>
            <p class="ini-1">Ver todos nuestros productos Obtener asistencia con los Productos y Servicios. 
            </p>
            <p class="ini-1">Todos los días, Mas ayuda a aumentar la seguridad online de miles de millones de personas. Protegemos a nuestros usuarios con una seguridad líder en el sector, prácticas responsables relacionadas con datos y controles de privacidad fáciles de utilizar.</p>

            <p class="ini-1">No estás solo, nosotros te ayudamos...
                Nuestro servicio comienza con la atención personalizada y el asesoramiento. Nuestro objetivo es ayudar a que puedas desarrollar tus proyectos de impresión con la mayor calidad al mejor precio posible.

                Además contamos con un departamento de diseño gráfico que supervisará tus trabajos para asegurarnos de que la calidad del resultado final se corresponda con tus espectativas.</p>
