...
<header>
    ...
    <main class="main-add-1">
        ...
        <fieldset>
            ...
            <legend>Area <?php echo "$_SESSION[nombre]" ?> / Buscar Factura</legend>

            <form name="datos" action="f_buscar_2.php" enctype="multipart/form-data" method="POST">

                <table>
                    <tr>
                        <td>Id Factura:</td>
                        <td><input type="number" name="id_factura" id="id_factura" placeholder='Id Factura'></td>
                    ...
                    <td>Fecha desde:</td>
                        <td><input type="date" name="fecha1" id="fecha1" ></td>
