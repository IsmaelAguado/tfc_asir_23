...
<header>
    ...
    <main class="main-add-1">
        ...
        <fieldset class="fiel">
            ...
            <legend>Area <?php echo "$_SESSION[nombre]" ?> / Crear Factura</legend>

            <form name="datos"  action="f_crear_2.php" enctype="multipart/form-data" method="POST">

                <table>
                    <tr>
                        <td>Id Presupuesto:</td>
                        <td><input type="number" name="id_presupuesto" id="id_presupuesto" placeholder='Id Presupuesto'></td>
                        <td class="td_error"><span id="id_presupuesto_alert"></span></td>
            ...
            $query = "select * from presupuesto where aceptado='1';";
            ...
            ?>
                ...
                <input class='margin' type="submit" value="Crear">
