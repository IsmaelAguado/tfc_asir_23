...
<header>
    ...
    <main>
    <div class="ini-gale">mas Design</div>
        <div class="main-gale-2">

                        <div class="gale-big">
                        <img class="gal-img-2"src="./img/<?php echo $_GET['var_img']?>-gale.jpg" alt="">
                        </div>
        
        </div>
        <a href="galeria.php"><button class="margin">Volver</button></a>
    </main>
