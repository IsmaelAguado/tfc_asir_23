...
<header>
    ...
    <main class="main-add-1">
        ...
        <fieldset>
            ...
            <legend>Area <?php echo "$_SESSION[nombre]" ?> / Buscar Clientes</legend>
            ...
            $query = "select * from cliente where id_usuario='$id_usuario' or nombre='$nombre' or mail='$mail' or tipo_usuario='$tipo'";

            // $query = "select * from cliente where id_usuario='$id_usuario' or nombre='$nombre' or mail='$mail' or tipo='$tipo'";
