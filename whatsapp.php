...
<header>
    ...
    <video class='vid_3' src="./video/social_network_-_119290 (Original).mp4" autoplay="true" muted="true" loop="true">
        </video>
        <div class="redes">

                        <img class="redes-1" src="./img/whatsapp.jpg" alt="Whatsapp">
