...
<header>
    ...
    <main class="main-add-1">
        ...
        <fieldset>
            ...
            <legend>Area <?php echo "$_SESSION[nombre]" ?> / Buscar Cliente</legend>

            <form name="datos" action="c_buscar_2.php" enctype="multipart/form-data" method="POST">

                <table>
                    <tr>
                        <td>Id Usuario:</td>
                        <td><input type="number" name="id_usuario" id="id_usuario" placeholder='Id Usuario'></td>
                        <td class="td_error"><span id="id_usuario_alert"></span></td>
                    ...
                    <tr>
                        ...
                        <td class="td_error"><span id="mail_alert"></span></td>
