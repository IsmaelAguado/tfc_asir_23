...
<body>
    ...
    <main class="main-add-1">
        ...
        <fieldset>
            ...
            <legend>Area <?php echo "$_SESSION[nombre]" ?> / Borrar Presupuesto</legend>

            <form name="datos" action="" enctype="multipart/form-data" method="POST">
                ...
                <div class="borrar">
                    ...
                    $query2 = "insert into facturas (id_presupuesto,id_usuario,total,iva,total_iva,fecha) values ('$id_presupuesto','$id_usuario','$total','$iva','$total_iva','$fecha')";
                    ...
                    if (mysqli_query($conexion, $query2)) {
                        ...
                        echo "<div  class='add-1'>
                        <span> Se han creado la factura con número de presupuesto $id_presupuesto de la base de datos.</span></div>";
                    } else {

                        echo "<div class='add-1'><span >Error al crear la factura con número de  presupuesto" . $id_presupuesto . " de la base de datos.</span></div>";
                    }
